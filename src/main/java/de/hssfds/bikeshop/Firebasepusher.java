...
public class Firebasepusher {
    ...
    public static void pushToFirebase(String key, String value, String token) {
        ...
        String url = "https://bikeshop-21511-default-rtdb.europe-west1.firebasedatabase.app/" + key + ".json?auth=" + token;
    ...
    public static String generateToken(String email, String password) {
        String appId = "AIzaSyAdlqnGugtqRNuRRmiNSa5uvdzXoOlKft8";
